...
{
/* IO Initial ----------------------------------------------------------------*/
   ADC_PORT->ODR |= ADC_MAN_FAN_PIN + ADC_CARTRIDG_PIN;  /* Out Hight */
   ADC_PORT->CR1 &= ~ADC_MAN_FAN_PIN; /* Floating Input */
   ADC_PORT->CR1 |= ADC_CARTRIDG_PIN; /* Pull Up Input */
   ADC_PORT->CR2 &= ~(ADC_MAN_FAN_PIN + ADC_CARTRIDG_PIN); /* Disable External Interrupt */
   ADC_PORT->DDR &= ~(ADC_MAN_FAN_PIN + ADC_CARTRIDG_PIN); /* Input Model */
...
/* ADC Initial ---------------------------------------------------------------*/  
   ...
   ADC1->TDRL |= 0x06;    /* Disable Schmitt Trigger AN1,AN2*/
